...
# creating a new object called abalone_clean from the original data set
...
ggplot(data = abalone_clean, # data set should be clean
       aes(x = mean_ph, # x-axis should be predictor, y-axis should be response
           y = change_in_area)) +
  # first-layer: points to represent average change in shell surface area of each pair of tanks
  geom_point(size = 4,
             stroke = 1,
             fill = "firebrick4",
             shape = 21)
...
**ank B1B, where the pH sensor failed**  
...
**-18.5 ± 6.16 (SE). When pH = 0, the model predicts that abalone change in shell surface area per day is -18.5 ± 6.16 (SE). (Note to self: this is not necessarily biologically realistic, but it is something the model generates as an estimate).**
